...
% \paragraph{1. Konto erstellen (Optional)}  $(apk \leftarrow account-public-key)$
%Als erster Schritt der Coin Generationphase, kann der Datennutzende sich eine Konto erstellen auf dem der CoinGenerationToken abgelegt wird. Ein neu hinzugekommener Datennutzender muss diesen Schritt zuerst mindestens ein Mal ausführen. Für allwelches e danach folgenden Generierungsphasen kann er sich entscheiden jedes Mal ein neues Konto zu erstellen oder ein bestehendes wieder zu verwenden. Ein Konto besteht aus einem public key. Der Datennutzende der dieses erstellt hat, hält den dazu gehörigen private key. Das Konto stellt ein Pseudonym dar, 
