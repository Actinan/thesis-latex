...
%Kurz konkret erläutern was das genau Ziel der Arbeit ist und wie dies erreicht wird.
%Für welches Datentreuhändermodell passt das Ziel am besten, wo kann man es eher schlecht einsetzen

%Warum nicht Qualitätsicherung dem DT überlassen und keine reputation?
...
%Designentscheidungen erklären. Darauf eingehen warum der gewählte Ansatz am besten ist und warum er nicht noch weiter verbessert werden kann/soll

%Da ein DN einen Datentype beim DT anfragt, kriegt er denk ich mal Datensätze von vielen DG. Soll das system dafür "Batchpayment" anbieten, sodass der DN nur eine Transaktion macht und nicht mit jedem einzelnen DG eine eigene?

%ie soll die Auswahl von DG stattfinden? DN kann threshold angeben? DN kann DG direkt auswählen
%=> Erstmal mit threshold anfangen. Sollte das später nicht funktionieren kann auch auf DG mit reputation herauspicken geswitched werden

%Zahlungsdaten werden nicht über Merchant geleitet da dieser entschlüsseln kann \cite{pant2011secure}
...
%    \bibliography{references.bib}        % Falls Biblatex verwendet wird.
    \printbibliography
